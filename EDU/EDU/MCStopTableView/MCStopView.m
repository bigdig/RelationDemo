...
//        
//        if (offsetY >=0) {
//            CGFloat alpha = MIN(1, offsetY/(weakHeight - NAV_H));
//            
...
-(void)prepareContentViews{
    ...
    for (NSInteger i = 0; i<_contentViews.count; i++) {
        ...
        v.frame = CGRectMake(x, v.frame.origin.y, v.frame.size.width , _selfView_frame.size.height-_segmentBarHeight-_headerView_Height);
...
-(void)scrollViewDidScroll:(UIScrollView *)scrollView
{
    ...
    CGFloat offh = _headerView_Height - NAV_H;
...
//    if (offsetY >0) {
//        CGFloat alpha = MIN(1, offsetY/(_headerView_Height - NAV_H));
//        
