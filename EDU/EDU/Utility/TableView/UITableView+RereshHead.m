...
static char kSignalDataRefreshing;
//
//@interface UITableView ()<DZNEmptyDataSetSource,DZNEmptyDataSetDelegate>
//
//@end
...
@implementation UITableView (RereshHead)
...
- (void)setDataRefreshingSignal:(RACSignal *)dataRefreshingSignal
{
    objc_setAssociatedObject(self, &kSignalDataRefreshing, dataRefreshingSignal, OBJC_ASSOCIATION_RETAIN_NONATOMIC);
    [self setupHeader];
    
}

- (RACSignal*)dataRefreshingSignal
{
    return objc_getAssociatedObject(self, &kSignalDataRefreshing);
}
