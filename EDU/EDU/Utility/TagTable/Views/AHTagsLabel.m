...
- (void)tap:(UITapGestureRecognizer *)recognizer {
    ...
    [self setTags:_tags];
    [Configuration Instance].tagID = tag.ID;
    [Configuration Instance].tagName = tag.title;
}
...
- (void)setTags:(NSArray<AHTag *> *)tags {
    ...
    for (NSInteger i = 0; i < tags.count; i++) {
        ...
        
        {
            ...
            //fix: three element per line
            view.frame = CGRectMake(0, 0, Main_Screen_Width/3 - 6, 30);
        }
