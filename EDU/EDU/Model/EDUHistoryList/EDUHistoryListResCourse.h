...
@class EDUHistoryListResAuth;

@interface EDUHistoryListResCourse : NSObject <NSCoding, NSCopying>
...
@property (nonatomic, strong) EDUHistoryListResAuth *resAuth;
