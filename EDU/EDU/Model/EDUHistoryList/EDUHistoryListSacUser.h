...
@class EDUHistoryListSacRole;

@interface EDUHistoryListSacUser : NSObject <NSCoding, NSCopying>
...
@property (nonatomic, strong) EDUHistoryListSacRole *sacRole;
